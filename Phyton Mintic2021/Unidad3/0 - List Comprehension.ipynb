 ...
 "cells": [
  {
   ...
   "metadata": {},
   "source": [
    "# Recordando lo visto hasta ahora..."
   ]
  },
  {
   "cell_type": "markdown",
  ...
  },
  {
   ...
   "source": [
    "## Para pensar...\n",
    "\n",
    "Si la función Dijkstra solo recibiera el diccionario con las distancias. cómo calcularía las demás entradas usando comprensión de listas? (no visitados, vecinos)"
   ]
  }
 ],
 "metadata": {
