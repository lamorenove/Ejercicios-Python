...
def asignacion_incremento(diccionario: dict) -> dict:
    return (diccionario['nombre']+" - " + "Salario: " + str(diccionario['salario']) + " " + "Antiguedad " + str(reporte['antiguedad']) + " " + "años" + " " + reporte['valor_incremento'])
