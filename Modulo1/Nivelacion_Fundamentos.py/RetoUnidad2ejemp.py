""" Función que regresa la persona cuya edad es mayor, dentro de una 
        población de N personas
        -La función recibe una lista de diccionarios como parametro que 
        contiene la población, las llaves del diccionario son 'nombre', 'edad'
        -En caso de que existan edades iguales regresar la primera persona de la 
        población con la edad igual
...
# [{'nombre':'Felipe', 'edad':43}, {'nombre':'Maria', 'edad':34}, # {'nombre':'Camila', 'edad':19}, {'nombre':'Carlos', 'edad':33}, # {'nombre':'Juan', 'edad':43}]
